...
Encoder left_enc(3, 12, []{ left_regulator.encoder.encoder_int(); }, true);   // INT0 (pin 2), B=11, invert=true
Encoder right_enc(2, 13, []{ right_regulator.encoder.encoder_int(); }, false); // INT1 (pin 3), B=12, invert=false
